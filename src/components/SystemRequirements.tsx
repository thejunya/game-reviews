    ...
    return (
        <>
            <p className="display-6 text-light">
                Рекомендуемая конфигурация для игры с частотой 60 кадров в секунду в большинстве ситуаций при высоких
                параметрах качества графики
            </p>
            <Table>
                <tbody className="text-light">
                    <tr>
                        <th scope="row">ОС</th>
                        <td>
                            64-разрядная Windows 10 с последним обновлением или 64-разрядная Windows 11 с последним
                            обновлением
                        </td>
                    </tr>
                    <tr>
...
export function Competitive() {
    return (
        <>
            <p className="display-6 text-light">
                Конкурентные спецификации для работы с высоким FPS для использования с монитором с высокой частотой
                обновления
            </p>
            <Table>
                <tbody className="text-light">
